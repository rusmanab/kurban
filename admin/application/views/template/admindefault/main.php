...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url('assets/themes/default/global/plugins/font-awesome/css/font-awesome.min.css')?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url('assets/themes/default/global/plugins/simple-line-icons/simple-line-icons.min.css')?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url('assets/themes/default/global/plugins/bootstrap/css/bootstrap.min.css')?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url('assets/themes/default/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css')?>" rel="stylesheet" type="text/css" />
        <!-- END GLOBAL MANDATORY STYLES -->
        <?php echo $csshead ."\r\n"?>
        <!-- BEGIN THEME GLOBAL STYLES -->
        <link href="<?php echo base_url('assets/themes/default/global/css/components.min.css')?>" rel="stylesheet" id="style_components" type="text/css" />
        <link href="<?php echo base_url('assets/themes/default/global/css/plugins.min.css')?>" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <?php echo $csshead2 ."\r\n"?>
        <!-- BEGIN THEME LAYOUT STYLES -->
        <link href="<?php echo base_url('assets/themes/default/layouts/layout/css/layout.min.css')?>" rel="stylesheet" type="text/css" />
