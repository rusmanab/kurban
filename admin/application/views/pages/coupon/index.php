                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            ...
                                            <div class="actions">
                                                <a href="<?php echo site_url('coupon/add')?>" class="btn btn-default btn-sm">
                                                ...
                                                <a href="<?php echo site_url('coupon/delete')?>" class="btn red btn-sm btn-delete">
                                                    ...
                                                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="datatable_ajax">
                                                        <thead>
                                                            <tr role="row" class="heading">
                                                                    ...
                                                                    <th width="40%"><?php echo $this->lang->line('coupon_name') ?></th>
                                                                    <th width="40%"><?php echo $this->lang->line('code') ?> </th>
                                                                    <th width="1%"><?php echo $this->lang->line('status') ?> </th>
                                                            </tr>                                                        
                                                        </thead>
                                                        <tbody> 
                                                        </tbody>
