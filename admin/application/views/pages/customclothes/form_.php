                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    if ( $clothes ){
                                        ...
                                        $category_id            = $clothes->clothes_category;
                                        $subcategory            = $clothes->sub_category_id;
                                    ...
                                    ?>
                                        ...
                                        <input type="hidden" name="skuold" value="<?php echo $sku; ?>" />
                                        <div class="portlet">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-9">
                                                                                    <select class="table-group-action-input form-control input-medium" name="sub_category_id" id="subcategory">
                                                                                        ...
                                                                                        <option value="<?php echo $s->id ?>" <?php echo $s->id==$subcategory ? "selected" : "" ?> ><?php echo $s->category_name ?></option> 
                                                                                        <?php } ?>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
