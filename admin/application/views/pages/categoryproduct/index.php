                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            ...
                                            <div class="actions">
                                                <a href="<?php echo site_url('categoryproduct/add')?>" class="btn btn-default btn-sm">
                                                ...
                                                <a href="<?php echo site_url('categoryproduct/delete')?>" class="btn red btn-sm btn-delete">
                                                    ...
                                                    <table class="table table-striped table-hover table-bordered dataTable no-footer" id="datatable_ajax">
                                                        <thead>
                                                            <tr role="row" class="heading">
                                                                    ...
                                                                    <th width="70%"><?php echo $this->lang->line('category') ?> </th>
                                                                    <th width="18%"><?php echo $this->lang->line('created_at') ?> </th>
                                                            </tr>                                                        
                                                        </thead>
                                                        <tbody> 
                                                        </tbody>
