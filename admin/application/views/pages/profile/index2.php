                                    ...
                                    <div class="profile-sidebar">
                                        ...
                                        <div class="portlet light profile-sidebar-portlet ">
                                            ...
                                            <div class="profile-usertitle">
                                                <div class="profile-usertitle-name"> <?php echo $nama_lengkap ?> </div>
                                                <div class="profile-usertitle-name"> <?php echo $nip ?> </div>
                                                <?php //<div class="profile-usertitle-job"> Developer </div> ?>
                                            </div>
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title tabbable-line">
                                                        <div class="caption caption-md">
                                                            ...
                                                            <span class="caption-subject font-blue-madison bold uppercase"><?php echo $this->lang->line('profile_akun')?></span>
                                                        </div>
                                                        <ul class="nav nav-tabs">
                                                            ...
                                                            <li>
                                                                <a href="#tab_1_4" data-toggle="tab"><?php echo $this->lang->line('ubah_pengguna')?></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div class="portlet-body">
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane active" id="tab_1_1">
                                                                ...
                                                                ?>
                                                                    <input type="hidden" name="pegid" value="<?php echo $pegId?>" />
                                                                    <div class="form-group">
                                                                        <label class="control-label"><?php echo $this->lang->line('nama')?></label>
                                                                        <input type="text" placeholder="John" name="nama_lengkap" class="form-control" value="<?php echo $nama_lengkap ?>" /> </div>
                                                                     <div class="form-group">
                                                                        <label class="control-label"><?php echo $this->lang->line('telp')?></label>
                                                                        <input type="text" placeholder="+1 646 580 DEMO (6284)" name="hp" class="form-control" value="<?php echo $no_telephone?>" /> </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label"><?php echo $this->lang->line('alamat')?></label>
                                                                        <textarea class="form-control" rows="3" name="alamat" ><?php echo $alamat ?></textarea>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label class="control-label"><?php echo $this->lang->line('tentang')?></label>
                                                                        <textarea class="form-control" rows="3" name="tentang"><?php echo $tentang ?></textarea>
                                                                    </div>
                                                            ...
                                                            <div class="tab-pane" id="tab_1_4">
                                                                ...
                                                                echo form_open(site_url($urlBase.'/changeusername'),$attributes);
                                                                ?>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label"><?php echo $this->lang->line('username_baru')?></label>
                                                                        <input type="text" name="new_username" class="form-control" required /> </div>
