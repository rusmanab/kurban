<?php
class Productfeatured extends MY_Controller{
    ...
    public function __construct(){
        ...
        $this->load->model('mproductfeatured','product');
    }
    
    public function index(){
        $data['title']     = $this->lang->line('featured_product');
        $data['subTitle']  = $this->lang->line('list_of').$this->lang->line('featured_product');
        $data['formtitle'] = "";
        $data['icon']      = "list";
    ...
    public function add(){
        ...
        $data['title']     = $this->lang->line('featured_product');
        $data['subTitle']  =  strtolower( $this->lang->line('add') ." " . $this->lang->line('featured_product') );
        $data['formtitle'] = $this->lang->line('add');
        $data['icon']      = "shopping-cart";
        
        $breadcrumb = array( array($this->lang->line('home') => '' ),
                             array( $data['title'] => 'featured_product' ),
                             $this->lang->line('add')
                             );
        $data['breadcrumb'] = breadcrumb($breadcrumb);
        $regCss = array(
        ...
        $addjs = "pages/productfeatured/js";
        $this->theme_admin->registerScript($addjs);
    ...
    public function edit($id){
        ...
        $data['title']     = $this->lang->line('featured_product');
        $data['subTitle']  = strtolower( $this->lang->line('edit') . " ".  $this->lang->line('featured_product') );
        ...
        $addjs = "productfeatured/product/js";
        $this->theme_admin->registerScript($addjs);
    ...
    public function save(){
        ...
        if (is_array($data)){
            ...
            if ($this->db->insert_batch('tbl_product_featured', $dataProduct)){    
