<?php
class Productspecial extends MY_Controller{
    ...
    public function __construct(){
        ...
        $this->load->model('mproductspecials','product');
    }
    
    public function index(){
        $data['title']     = $this->lang->line('special_product');
        $data['subTitle']  = $this->lang->line('list_of').$this->lang->line('special_product');
        $data['formtitle'] = "";
        $data['icon']      = "list";
    ...
    public function add(){
        ...
        $data['title']     = $this->lang->line('special_product');
        $data['subTitle']  =  strtolower( $this->lang->line('add') ." " . $this->lang->line('special_product') );
        $data['formtitle'] = $this->lang->line('add');
        $data['icon']      = "shopping-cart";
        
        $breadcrumb = array( array($this->lang->line('home') => '' ),
                             array( $data['title'] => 'special_product' ),
                             $this->lang->line('add')
                             );
        $data['breadcrumb'] = breadcrumb($breadcrumb);
        $regCss = array(
    ...
    public function edit($id){
        ...
        $data['title']     = $this->lang->line('special_product');
        $data['subTitle']  = strtolower( $this->lang->line('edit') . " ".  $this->lang->line('special_product') );
        ...
        $addjs = "productspecial/product/js";
        $this->theme_admin->registerScript($addjs);
    ...
    public function save(){
        ...
        if (is_array($data)){
            ...
            if ($this->db->insert_batch('tbl_product_specials', $dataProduct)){    
