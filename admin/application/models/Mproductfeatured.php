<?php
class Mproductfeatured extends MY_Model{
    protected static $table	='tbl_product_featured';
    ...
    public function getDataTable($clothestype=1, $condition=''){
	  ...
	  $sIndexColumn = 'id';
        ...
        $columns = array(
                        ...
                        array('db'=>'post_status', 'dt'=>4,  'suffix' =>'p',
                             'formatter' => function( $d, $row ){
                                    ...
                                    $action = '<a class="btn red btn-sm" href="'.site_url('productfeatured/delete/'.$row['id']).'">Delete</a>';
                                    return $action;
                             })
                    );
        ...
        $Joinquery.= "FROM tbl_product_featured t ";
