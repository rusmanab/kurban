...
class Api extends API_Controller{
    ...
    public function register(){
        ...
        if ($cekEmail){
            $response['error']      = true;
            $response['error_msg']  = "Pendaftaran akun gagal, email sudah terdaftar.";
            $errSts = 200;
    ...
    public function kirimEmail($view,$data){
        ...
        /*$config['smtp_host']    = 'mail.zambon-indonesia.com';
        $config['smtp_port']    = '587';
        $config['smtp_timeout'] = '30';
        $config['smtp_user']    = 'zi.crm@zambon-indonesia.com';
        $config['smtp_pass']    = 'zicrm1906';
        ...
        $message = $this->load->view("mail/" . $view , $data, true);
