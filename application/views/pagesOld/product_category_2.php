                            ...
                            <figure>
                                ...
                                <div class="lovewishlist">
                                    <ul>
                                        ...
                                        <li class="icon-search"><a class="quickview iframe-link " data-fancybox-type="iframe" href="<?php echo base_url("index.php/product/".$row->url_slug);  ?>">  <i class="fa fa-search" aria-hidden="true"></i></a></li>
                                    </ul>
                                </div>
                            </figure>
                        </a>
